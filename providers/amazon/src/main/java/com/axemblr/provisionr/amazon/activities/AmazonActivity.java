...
public abstract class AmazonActivity implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        checkArgument(pool != null, "Please add the pool description as a process " +
    ...
    AmazonEC2 newAmazonEc2Client(Provider provider) {
        String region = provider.getOptions().get("region");
        ...
        LOG.info("<< Using endpoint {} for region {}", result.getRegions().get(0), region);
